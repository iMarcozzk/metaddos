...
GOLDENEYE_BANNER = 'METADDOS Feito por iMarcozzk'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} METADDOS strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(GOLDENEYE_BANNER)
    print()
    print(' USAGE: ./metaddos.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
